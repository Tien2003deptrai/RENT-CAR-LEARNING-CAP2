...
router.post("/createVehicleLocation/:vehicleId", vehicleLocationController.createVehicleLocation);

router.get("/getVehicleLocationByVehicleId/:vehicleId", vehicleLocationController.getVehicleLocationByVehicleId);
