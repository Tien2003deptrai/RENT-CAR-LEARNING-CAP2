...
class VehicleValidation {
    createVehicle = [
        ...
        body("vehicle_images_paths").optional().isArray().withMessage("vehicle_images_paths bắt buộc là mảng"),
        body("vehicle_images_paths.*").optional().isURL().withMessage("vehicle_images_paths phải là URL hợp lệ"),
